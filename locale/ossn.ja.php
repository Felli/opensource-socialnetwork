 ...
 * @author    Felli <felli-sama@asia.com>
 * @copyright (C) Felli
 * @license   Open Source Social Network License (OSSN LICENSE)  http://www.opensource-socialnetwork.org/licence
 * @link      https://felli.github.io/
 */
...
$en = array(
	...
	'home:top:heading' => "％s! へようこそ今すぐ参加して、新しい友達を作ったり、グループを作成したり、写真を追加したりなどしましょう。",
	'create:account' => 'アカウントを作成する',
	'its:free' => "無料ですし、いつでもそうなるでしょう。",
